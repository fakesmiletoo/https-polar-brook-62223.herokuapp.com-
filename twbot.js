...
// This is the URL of a search for the latest tweets on the 'pensando' words
const mediaArtsSearch = { q: "pensah", count: 1, result_type: "recent" };

// This function finds the latest tweet with the pensando retweets.
const retweetLatest = () => {
